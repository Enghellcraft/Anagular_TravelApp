...
export class ProfileComponent implements OnInit {
  ...
  checkSelected(vehiclePreference: string) {
    let prefProp = eval('this.' + vehiclePreference)
    eval(`this.${vehiclePreference} = !${prefProp}`)
    this.isSelected = !prefProp
    this.isSelected
      ? this.addVehiclePreference(vehiclePreference)
      : this.removeVehiclePreference(vehiclePreference)
  }
